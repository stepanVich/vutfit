...
\begin{quotation}
Čím více \texttt{druhů}, \textbf{\textit{řezů}}, velikostí, barev písma {\fontfamily{cmss} \selectfont a jiných efektů} použijeme, tím \emph{profesionálněji} bude dokument vypadat. Čtenář tím {\tiny bude} vždy {\huge \textbf{nadšen!}}
\end{quotation}
